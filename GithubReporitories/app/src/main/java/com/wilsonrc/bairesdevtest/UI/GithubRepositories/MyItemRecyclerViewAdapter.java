...
import com.wilsonrc.bairesdevtest.UI.GithubRepositories.ItemFragment.OnListFragmentInteractionListener;
import com.wilsonrc.bairesdevtest.UI.GithubRepositories.dummy.DummyContent.DummyItem;
...
//        holder.mContentView.setText(mValues.get(position).content);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mRepoName =  view.findViewById(R.id.repo_name);
        }
